...
# These IPs bypass all security checks and are always forwarded directly.
# Add your office/home IP here if you're getting false positives.
# Private RFC-1918 ranges (192.168.x.x, 10.x.x.x) are always trusted.
# -----------------------------------------------------------------------------
TRUSTED_IPS = {
    "127.0.0.1",   # localhost IPv4
    "::1",         # localhost IPv6
    "0.0.0.0",     # any-address
    # "203.0.113.5",  # ← add your static IP here if needed
}

# Also trust entire private subnets (checked by prefix in proxy_server.py)
